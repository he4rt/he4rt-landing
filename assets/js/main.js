...
const forNoobs = [
    { img_url: 'https://yt3.ggpht.com/g8lfkmyHXwpjIBHoNgHgip2m4LSnR-8gsVa-1DG05JGVuTrIIjJ9x4tUNuYvDuH7OHyCHqnnwQ=s900-c-k-c0x00ffffff-no-rj', owner: 'Mc Poze do Rodo', role: 'Músico', name: 'Nice', category: 'Funk', content: 'Lorem ipsum meu deus do ceu mata o khazix pelo menos yoda', url: 'https://github.com/' },
...
forNoobs.forEach((forNoob) => {
    ...
    <div class="swiper-slide">
        <div class="flex flex-col rounded-lg w-44 md:w-72 drop-shadow-xl overflow-hidden">
            <div class="w-full bg-gradient-to-r from-purple-500 to-pink flex items-center justify-between text-white p-3">
                <div class="flex items-center">
                    <div class="w-1/4 p-2 mr-3">
                        <img src="https://yt3.ggpht.com/g8lfkmyHXwpjIBHoNgHgip2m4LSnR-8gsVa-1DG05JGVuTrIIjJ9x4tUNuYvDuH7OHyCHqnnwQ=s900-c-k-c0x00ffffff-no-rj" class="rounded-full shadow-2xl">
                    </div>
                    <div>
